...
export function CourseDetailsPage() {
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <Loader2 className="w-12 h-12 animate-spin text-[#9d197d] mx-auto mb-4" />
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/cursos" className="text-[#9d197d] hover:underline">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="bg-[#9d197d] text-white py-12 relative overflow-hidden">
                ...
                <div className="flex p-1 bg-gray-100/80 rounded-xl">
                  <button
                    ...
                    className={cn(
                      ...
                      activeTab === 'details' 
                        ? "bg-white text-[#9d197d] shadow-md transform scale-[1.02]" 
                ...
                {activeTab === 'details' ? (
                  <div className="space-y-8 animate-in fade-in duration-300">
                    ...
                    {course.description && (
                      <section>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <BookOpen className="w-6 h-6 text-[#9d197d]" />
                          Sobre o Curso
                        </h3>
                        <div 
                    ...
                    {course.objectives && (
                      <section>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <Target className="w-6 h-6 text-[#9d197d]" />
                          Objetivos
                        </h3>
                        <div 
                          className="text-gray-600 leading-relaxed text-lg prose prose-lg max-w-none"
                    ...
                    {course.syllabus && (
                      <section>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <FileText className="w-6 h-6 text-[#9d197d]" />
                          Ementa do Curso
                        </h3>
                        <div 
                          className="text-gray-600 leading-relaxed text-lg prose prose-lg max-w-none"
                    ...
                    {course.jobMarket && (
                      <section>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <Briefcase className="w-6 h-6 text-[#9d197d]" />
                          Mercado de Trabalho
                        </h3>
                        <div 
                          className="text-gray-600 leading-relaxed text-lg prose prose-lg max-w-none"
                    ...
                    {course.requirements && (
                      <section>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <CheckCircle2 className="w-6 h-6 text-[#9d197d]" />
                          Requisitos para Matrícula
                        </h3>
                        <div 
                          className="text-gray-600 leading-relaxed text-lg prose prose-lg max-w-none"
                    ...
                    {course.technicalRequirements && (
                      <section>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <Laptop className="w-6 h-6 text-[#9d197d]" />
                          Requisitos Técnicos
                        </h3>
                        <div 
                          className="text-gray-600 leading-relaxed text-lg prose prose-lg max-w-none"
                  ...
                  <div className="space-y-6 animate-in fade-in duration-300">
                    <div className="flex items-center justify-between mb-8">
                      ...
                      {curriculumBySemester.length > 0 && (
                        <div className="hidden md:flex items-center gap-2 bg-gradient-to-r from-[#9d197d]/10 to-purple-50 px-4 py-2 rounded-xl border border-[#9d197d]/20">
                          <BookOpen className="w-5 h-5 text-[#9d197d]" />
                          <span className="text-sm font-bold text-[#9d197d]">{curriculumBySemester.length} Semestres</span>
                        </div>
                      )}
                    </div>
                    ...
                    {curriculumBySemester.length > 0 ? (
                      <div className="space-y-4">
                        {curriculumBySemester.map((period: any, index: number) => (
                          <div key={index} className="border-2 border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:border-[#9d197d]/20 transition-all duration-300 bg-white group/card">
                            <div 
                            ...
                            >
                              <div className="flex items-center gap-5">
                                <div className={cn(
                                  ...
                                  openPeriod === index 
                                    ? "bg-gradient-to-br from-[#9d197d] to-purple-600 text-white rotate-3 scale-110" 
                                    : "bg-gradient-to-br from-gray-100 to-gray-50 text-gray-500 group-hover/card:from-[#9d197d]/10 group-hover/card:to-purple-50 group-hover/card:text-[#9d197d]"
                                )}>
                                  {index + 1}º
                                </div>
                                <div>
                                  <h4 className={cn(
                                    ...
                                    openPeriod === index ? "text-[#9d197d]" : "text-gray-800 group-hover/card:text-[#9d197d]"
                                  )}>
                                    {period.period}
                                  </h4>
                              ...
                              <div className="flex items-center gap-4">
                                <div className="hidden sm:flex items-center gap-2 text-xs font-medium text-gray-500 bg-white px-3 py-1.5 rounded-lg border border-gray-100 shadow-sm">
                                  <Clock className="w-3.5 h-3.5 text-[#9d197d]" />
                                  {period.subjects.reduce((acc: number, sub: any) => acc + sub.hours, 0)}h
                                </div>
                                <div className={cn(
                                  "w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300",
                                  openPeriod === index ? "bg-[#9d197d]/10 rotate-180" : "bg-gray-100 group-hover/card:bg-[#9d197d]/10"
                                )}>
                                  <ChevronDown className={cn(
                                    "w-5 h-5 transition-colors",
                                    openPeriod === index ? "text-[#9d197d]" : "text-gray-400 group-hover/card:text-[#9d197d]"
                                  )} />
                                </div>
                              </div>
                            </div>
                              ...
                              <div className="p-4 bg-gray-50/30">
                                <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden divide-y divide-gray-50">
                                  {period.subjects.map((subject: any, subIndex: number) => (
                                    <div key={subIndex} className="px-6 py-5 hover:bg-gradient-to-r hover:from-[#9d197d]/5 hover:to-purple-50/50 transition-all duration-200 group/item cursor-pointer">
                                      <div className="flex justify-between items-start gap-4">
                                        <div className="flex items-start gap-4 flex-1">
                                          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#9d197d]/10 to-purple-50 flex items-center justify-center flex-shrink-0 group-hover/item:from-[#9d197d]/20 group-hover/item:to-purple-100 transition-all">
                                            <BookOpen className="w-5 h-5 text-[#9d197d]" />
                                          </div>
                                          <div className="flex-1">
                                            <h5 className="font-bold text-gray-900 group-hover/item:text-[#9d197d] transition-colors">
                                              {subject.name}
                                            </h5>
                                            {subject.description && (
                                        ...
                                        <div className="flex items-center gap-2 text-sm font-bold text-[#9d197d] bg-gradient-to-r from-[#9d197d]/10 to-purple-50 px-3 py-1.5 rounded-lg flex-shrink-0">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24 space-y-6">
              ...
              <div className="space-y-4">
                {course.duration && (
                  <div className="flex items-start gap-3">
                    <Clock className="w-5 h-5 text-[#9d197d] mt-0.5 flex-shrink-0" />
                    <div>
                ...
                {course.modality && (
                  <div className="flex items-start gap-3">
                    <MapPin className="w-5 h-5 text-[#9d197d] mt-0.5 flex-shrink-0" />
                    <div>
                ...
                {course.type && (
                  <div className="flex items-start gap-3">
                    <GraduationCap className="w-5 h-5 text-[#9d197d] mt-0.5 flex-shrink-0" />
                    <div>
              ...
              <div className="pt-6 border-t border-gray-100">
                <Link href="/seja-parceiro">
                  <button className="w-full bg-gradient-to-r from-[#9d197d] to-purple-600 text-white py-3 px-6 rounded-xl font-bold hover:shadow-lg hover:scale-105 transition-all duration-300">
                    Quero ser Parceiro
                  </button>
                </Link>
              </div>
