        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <div className="inline-block mb-4">
              <span className="bg-gradient-to-r from-[#9d197d]/10 to-purple-100 text-[#9d197d] px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wider">Catálogo Completo</span>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12 bg-white p-8 rounded-3xl shadow-lg border-2 border-gray-100">
                  ...
                  <Button
                    ...
                    className={`rounded-full px-6 py-2.5 font-bold text-sm transition-all duration-300 ${
                      selectedCategory === category 
                        ? "bg-gradient-to-r from-[#9d197d] to-purple-600 hover:from-[#9d197d]/90 hover:to-purple-600/90 text-white shadow-lg shadow-[#9d197d]/30 scale-105" 
                        : "hover:bg-gray-100 hover:border-[#9d197d]/30 hover:text-[#9d197d]"
                    }`}
                  >
                    {category}
            ...
            <div className="relative w-full md:w-80">
              ...
              <Input 
                ...
                className="pl-12 pr-4 py-6 rounded-2xl border-2 border-gray-200 focus:border-[#9d197d] focus:ring-2 focus:ring-[#9d197d]/20 transition-all"
                value={searchTerm}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {filteredCourses.map(course => (
              <div key={course.id} className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group border-2 border-gray-100 hover:border-[#9d197d]/20">
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <span className="absolute top-4 right-4 z-20 bg-gradient-to-r from-[#9d197d] to-purple-600 text-white px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider shadow-lg">
                    {course.category}
                  </span>
                  <div className="absolute bottom-4 left-4 z-20 flex items-center gap-2">
                    <div className="bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-full flex items-center gap-1.5">
                      <Award size={14} className="text-[#9d197d]" />
                      <span className="text-xs font-bold text-gray-800">MEC</span>
                    </div>
                  </div>
                </div>
                <div className="p-7">
                  <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-[#9d197d] transition-colors leading-tight">
                    {course.title}
                  </h3>
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-500 border-t border-gray-100 pt-5 mb-5">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#9d197d]/10 to-purple-50 flex items-center justify-center">
                        <Clock size={16} className="text-[#9d197d]" />
                      </div>
                  ...
                  <Link href={`/cursos/${course.slug}`}>
                    <Button className="w-full bg-gradient-to-r from-[#9d197d] to-purple-600 hover:from-[#9d197d]/90 hover:to-purple-600/90 text-white font-bold rounded-xl py-6 text-base shadow-lg shadow-[#9d197d]/30 hover:shadow-xl hover:shadow-[#9d197d]/40 transition-all duration-300">
                      VER DETALHES
                    </Button>
                  </Link>
                </div>
