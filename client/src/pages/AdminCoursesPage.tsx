      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-between items-start">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-4xl font-bold bg-gradient-to-r from-[#9d197d] to-purple-600 bg-clip-text text-transparent">
                Gerenciar Cursos
              </h1>
          ...
          <Button 
            className="gap-2 bg-gradient-to-r from-[#9d197d] to-purple-600 hover:from-[#8a1570] hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-6 py-6 text-base font-semibold" 
        ...
        <div>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="h-1 flex-1 bg-gradient-to-r from-[#9d197d] via-purple-500 to-transparent rounded-full"></div>
          </div>
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-12">
                <div className="text-center">
                  ...
                  <Button 
                    className="gap-2 bg-gradient-to-r from-[#9d197d] to-purple-600 hover:from-[#8a1570] hover:to-purple-700 text-white" 
                    onClick={() => setLocation("/admin-la-educacao/cursos/novo")}
                  >
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-6">
                      ...
                      {course.image ? (
                        ...
                        <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center shadow-lg flex-shrink-0">
