                      ...
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-[#9d197d] transition-colors">
                              {action.title}
                            </h3>
                          ...
                          {/* Arrow */}
                          <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-[#9d197d] group-hover:translate-x-1 transition-all duration-300" />
                        </div>
                      </CardContent>
                    </Card>
                  </a>
